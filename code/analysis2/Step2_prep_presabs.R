...
maskfile="D:/Koma/Sync_PhD/_Amsterdam/_PhD/Chapter4_Sentinel/3_Dataprocessing/dataprocess_forpaper_march/both/lidar_VV_p25.tif"
...
bird_ahn3ac_filt_buff <- gBuffer(bird_ahn3ac_filt2, width = 200)
...
# Export
#raster::shapefile(presabs,"D:/Koma/Sync_PhD/_Amsterdam/_PhD/Chapter4_Sentinel/3_Dataprocessing/dataprocess_forpaper_march/both/presabs_GrW_rand",overwrite=TRUE)
raster::shapefile(presabs,"D:/Koma/Sync_PhD/_Amsterdam/_PhD/Chapter4_Sentinel/3_Dataprocessing/dataprocess_forpaper_march/both/presabs_SW_rand",overwrite=TRUE)
