...
GrW_lid=read.sdm("n_merged_GrW_lidar2.sdm")
GrW_sent=read.sdm("n_merged_GrW_sentinel2.sdm")
GrW_landc=read.sdm("n_merged_GrW_landc2.sdm")
GrW_lidsent=read.sdm("n_merged_GrW_lidsent2.sdm")
GrW_all=read.sdm("n_merged_GrW_all2.sdm")
...
GrW_sent_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
GrW_sent_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
GrW_sent_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
GrW_sent_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

GrW_lid_acc$modeltype<-NA
GrW_lid_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
GrW_lid_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
GrW_lid_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
GrW_lid_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

GrW_landc_acc$modeltype<-NA
GrW_landc_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
GrW_landc_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
GrW_landc_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
GrW_landc_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

GrW_lidsent_acc$modeltype<-NA
GrW_lidsent_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
GrW_lidsent_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
GrW_lidsent_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
GrW_lidsent_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

GrW_all_acc$modeltype<-NA
GrW_all_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
GrW_all_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
GrW_all_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
GrW_all_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

GrW_merged=rbind(GrW_lid_acc,GrW_sent_acc,GrW_landc_acc,GrW_lidsent_acc,GrW_all_acc)
GrW_merged=GrW_merged[GrW_merged$modeltype!="maxent_ps",]
...
Sn_lid=read.sdm("n_merged_Sn_lidar2.sdm")
Sn_sent=read.sdm("n_merged_Sn_sentinel2.sdm")
Sn_landc=read.sdm("n_merged_Sn_landc2.sdm")
Sn_lidsent=read.sdm("n_merged_Sn_lidsent2.sdm")
Sn_all=read.sdm("n_merged_Sn_all2.sdm")
...
Sn_sent_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
Sn_sent_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
Sn_sent_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
Sn_sent_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

Sn_lid_acc$modeltype<-NA
Sn_lid_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
Sn_lid_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
Sn_lid_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
Sn_lid_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

Sn_landc_acc$modeltype<-NA
Sn_landc_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
Sn_landc_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
Sn_landc_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
Sn_landc_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

Sn_lidsent_acc$modeltype<-NA
Sn_lidsent_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
Sn_lidsent_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
Sn_lidsent_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
Sn_lidsent_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

Sn_all_acc$modeltype<-NA
Sn_all_acc$modeltype[c(1:20,81:100,161:180,241:260,321:340)]<-"glm"
Sn_all_acc$modeltype[c(21:40,101:120,181:200,261:280,341:360)]<-"maxent_ps"
Sn_all_acc$modeltype[c(41:60,121:140,201:220,281:300,361:380)]<-"rf"
Sn_all_acc$modeltype[c(61:80,141:160,221:240,301:320,381:400)]<-"maxent"

Sn_merged=rbind(Sn_lid_acc,Sn_sent_acc,Sn_landc_acc,Sn_lidsent_acc,Sn_all_acc)
Sn_merged=Sn_merged[Sn_merged$modeltype!="maxent_ps",]
...
t1 <- textGrob("(a) Great reed warbler",gp=gpar(fontsize=25, col="black", fontface="bold"))
t2 <- textGrob("(b) Savi's warbler",gp=gpar(fontsize=25, col="black", fontface="bold"))
...
ggsave("fig2_ensav_vx_maxent.png",plot = fig2,width = 18, height =14)
...
write.csv(acc_GrW_table,"acc_GrW_table_maxent.csv")
write.csv(acc_Sn_table,"acc_Sn_table_maxent.csv")
...
write.csv(acc_GrW_table2,"acc_GrW_table_ens2_maxent.csv")
write.csv(acc_Sn_table2,"acc_Sn_table_ens2_maxent.csv")