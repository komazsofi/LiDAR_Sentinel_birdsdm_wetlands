...
birdsel_sp=birds_sp[(birds_sp@data$species=="Baardman"),]
...
bird_ahn3ac_filt_wlc=raster::extract(landcover_crop,bird_ahn3ac_filt2)
bird_ahn3ac_filt2@data$landcover <- bird_ahn3ac_filt_wlc
...
# generate absences
absence_cand=spsample(surveyplot_filt,n=5000,"random")
...
# Export
raster::shapefile(presabs,"D:/Koma/Sync_PhD/_Amsterdam/_PhD/Chapter4_Sentinel/3_Dataprocessing/dataprocess_forpaper_march/both/presabs_Ba_rand_studyarea",overwrite=TRUE)
